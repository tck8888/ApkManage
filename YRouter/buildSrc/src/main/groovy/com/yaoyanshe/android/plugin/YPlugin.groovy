...
import com.yaoyanshe.android.asm.YAsmVisitor
import com.yaoyanshe.android.asm.YRouterWriter
...
public class YPlugin extends Transform implements Plugin<Project>{
...
//        android.registerTransform(this)
     ...
     * 存放到HashMap中.
     */
    private void resolveClassVisitor(YAsmVisitor cv) {
     ...
     * 路由HashMap一遍生成路由表
     */
    private void parseProcotolClassVisitor(YAsmVisitor classVisitor) {
    ...
    void transform(Context context, Collection<TransformInput> inputs, Collection<TransformInput> referencedInputs, TransformOutputProvider outputProvider, boolean isIncremental) throws IOException, TransformException, InterruptedException {
                ...
                if (directoryInput.file.isDirectory()) {
                    directoryInput.file.eachFileRecurse { File file ->
                        ...
                        if (name.endsWith(".class") && isIgonre(name)) {
                            ...
                            YAsmVisitor classVisitor = new YAsmVisitor(Opcodes.ASM5, classWriter)
                ...
                if (filePath.endsWith(".jar")
                    ...
                    while (enumeration.hasMoreElements()) {
                        ...
                        if (entryName.endsWith(".class") && isIgonre(name)) {
                            ...
                            ClassWriter classWriter = new ClassWriter(classReader, ClassWriter.COMPUTE_MAXS)
                            YAsmVisitor cv = new YAsmVisitor(Opcodes.ASM5, classWriter)
         ...
         * 写入生成class文件
         */
        YRouterWriter neacyRouterWriter = new YRouterWriter()
